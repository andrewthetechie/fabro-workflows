...
hand. The dispatch loop and the lease are draft 08. The task series, the decisions
behind it and the contracts each later draft consumes are in `docs/scheduler/`,
starting at `00-overview-and-contracts.md`.
"""
